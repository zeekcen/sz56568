...
<table  class="search_table" width="100%">
	<tr>
		<td class="search">
			...
			<input id="title" type="text" class="input-text" name="keyword" value="<?php echo $keyword;?>" />
			<select name="searchtype">
			<?php if($fields['name']) { ?><option value="name" <?php if($searchtype=='name') { ?>selected="selected"<?php } ?>><?php echo L('name');?></option><?php } ?>
			...
			<?php if($row['parentid']==1) { ?><option value="<?php echo $row['typeid'];?>" <?php if($typeid==$row['typeid']) { ?>selected="selected"<?php } ?>><?php echo $row['name'];?></option><?php } ?>
			<?php $n++;}unset($n); ?>
			</select>
			<?php } ?>
			...
			<option value="id" <?php if($order =='id') { ?>selected="selected"<?php } ?>>ID</option>
			<option value="price" <?php if($order =='price') { ?>selected="selected"<?php } ?>>price</option>
			</select>
		...
		<thead>
      	...
      	<tbody>
			...
			<td align="center"><?php echo $vo['id'];?></td>
      		<td><?php if($vo['typeid']) { ?>[<font color="green"><?php echo $Type[$vo['typeid']]['name'];?></font>]<?php }  echo $vo['name'];?></td>
			<td><?php if($vo['logo']) { ?><img src="<?php echo $vo['logo'];?>" height=26><?php } ?>&nbsp;</td>
