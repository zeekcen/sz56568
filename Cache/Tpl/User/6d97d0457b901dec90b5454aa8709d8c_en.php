...
<div class="main">
	<h3><?php echo L(USER_REGISTER);?></h3>	 
		<div class="block-msg">
		<form id="YpForm"  method="post" action="<?php echo U('User/Register/doreg');?>" >
		<table width="100%">
		<tr>
			<td align="right" width="240" height="35px"><?php echo L(user_username);?>：</td>
			<td><input type="text" id="username" name="username" class="input-text" validate="required:true,en_num:true,remote: '<?php echo U('User/Register/checkusername');?>' , minlength:5, maxlength:20"/></td>
		</tr>

		<tr><td align="right" width="240" height="35px"><?php echo L(password);?>：</td><td><input type="password" class="input-text"  name="password" id="password" validate=" required:true, minlength:5, maxlength:20"></td></tr>
		<tr><td align="right" width="240" height="35px"><?php echo L(USER_repassword);?>：</td><td><input type="password" class="input-text"  name="repassword" validate=" required:true,equalTo: '#password', minlength:5, maxlength:20"></td></tr>

		<tr>
			<td align="right" height="35px"><?php echo L(email);?>：</td>
			<td><input type="text" id="email" name="email" class="input-text" validate="required:true,email:true,remote: '<?php echo U('User/Register/checkEmail');?>' , minlength:1, maxlength:40"/></td>
		</tr>
		...
		<tr>
			...
			<td height="50px"><input type="submit" class="button" value="<?php echo L(USER_REGISTER);?>" /></td>
		</tr>
		</table>
		</form>
		</div>	 
