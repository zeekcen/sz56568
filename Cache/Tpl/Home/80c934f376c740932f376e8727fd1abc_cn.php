...
<div class="left">
		<div class="pos"><b></b><span><?php echo L(catpos);?> <a href="<?php echo URL();?>"><?php echo L(home_font);?></a> &gt  <a href="<?php echo TAGURL();?>">Tags</a> &gt </span></div>
		<div class="list">
		<ul class="txt">
			<?php $n=1;if(is_array($list)) foreach($list AS $r) { ?>
					<li><a href="<?php echo TAGURL($r);?>" target="_blank"><?php echo $r['name'];?></a></li>
			<?php $n++;}unset($n); ?>
		</ul></div>
