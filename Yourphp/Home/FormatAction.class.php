...
class FormatAction extends BaseAction
{
	...
	{
		$modle = M('Content');
		$data = $modle->field('id,title,url,description,createtime')->where("status=1")->order('id desc')->limit('0,100')->select();
