...
class AttachmentAction extends  Action {
	...
	public function upload(){
        ...
        if (!$upload->upload()) { 
			...
			$data['filepath'] = YP_PATH.substr($uploadList[0]['savepath'].strtolower($uploadList[0]['savename']),1);
	...
	public function filelist(){
		...
		$list[$key]['thumb']=in_array($r['fileext'],$imagearr) ? $r['filepath'] : YP_PATH.'/Statics/Images/ext/'.$r['fileext'].'.png'; 
		}
